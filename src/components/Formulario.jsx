...
/* 
  REGLAS DE HOOKS:
  -Los hooks se agregan en la parte superior.
  -No se deben colocar dentro de condicionales, tampoco despues de un return.
  -Utilizar la variable modificacion para manipular.
  -
*/
function Formulario({pacientes, setPacientes, paciente}) {
  //States encagardos de los campos del formulario
  ...
  //State encargado de que si hay algo que no se cumpla, muestre un error
  ...
  const handleSubmit = (e) =>{
    ...
    if([nombre, propietario, email, fechaAlta, sintomas].includes("")){
      ...
      if(paciente.id){
        ...
        //Lleno la lista de Pacientes: Hago una copia de pacientes, porque si hago push, modifico el arreglo
  ...
  return (
    ...
    <div className="md:w-1/2 lg:w-2/5">
      ...
      <form onSubmit={handleSubmit} action="post" className="bg-white shadow-md rounded-lg py-10 px-5 mb-10">
        ...
        <div className="mb-5">
          ...
          <input id="propietario" className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md"  type="text" placeholder="Nombre de la mascota"
        ...
        <div className="mb-5">
          ...
          <input id="fecha" className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md"  type="date" 
        ...
        text-white uppercase font-bold hover:bg-indigo-700 transition-all" 
